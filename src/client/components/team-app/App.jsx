...
class TeamsAppUI extends React.Component {
  ...
  render() {
    if (
      this.props.currentGameStatus === "choose_categories" &&
      this.props.teamNameStatus === "success"
    ) {
      return <TeamCategorieMelding />;
    }
    if (
      this.props.currentGameStatus === "choose_question" &&
      this.props.teamNameStatus === "success"
    ) {
      return <TeamVragen />;
    }
    if (
      this.props.currentGameStatus === "asking_question" &&
      this.props.teamNameStatus === "success"
    ) {
